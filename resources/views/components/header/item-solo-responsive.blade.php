<li
    class="relative transition-all duration-300 cursor-pointer group w-full py-4 border-t
    ...
    <a href="{{ $href }}" class="flex items-center justify-between gap-3 px-5">
        <i class="text-sm text-white transition-all duration-300 icon-responsive fa-solid fa-angles-left"></i>
        <span class="py-0 text-lg font-semibold text-white whitespace-nowrap text">{{ $nome }}</span>
    </a>
</li>
