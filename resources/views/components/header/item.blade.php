<li
    ...
    <div class="flex items-center gap-2 lg:gap-4">
        <a href="{{ $href }}" class="text-sm font-medium text-white py-7 text xl:text-xs xl:py-5 lg:text-2xl lg:font-bold">{{ $nome }}</a>
        <i
    ...
    <div
        ...
        @if ($nome === 'Órgãos')
            ...
            <a href="{{ route('orgaos.smtt') }}"
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">Superintêndencia
                Municipal de
        ...
        @elseif($nome === 'Transparência')
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">MUNICÍPIO</a>
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">FMDCA</a>
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">FUMCTUR</a>
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">SAAE</a>
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">SEMAS</a>
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">SEMED</a>
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">SEMMA</a>
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">SMS</a>
            <a href=""
                class="text-xs xl:text-[10px] xl:font-light text-white transition-all duration-300 opacity-50 text hover:opacity-100 whitespace-nowrap">SMTT</a>
