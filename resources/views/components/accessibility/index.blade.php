<div class="fixed z-[9999] bottom-24 left-6">
    <div class="absolute flex w-52 -z-50 group">
        <div id="btn-accessibility"
            class="absolute flex items-center justify-center w-16 h-16 bg-blue-900 border-2 border-transparent rounded-full left-3 top-2/4 -translate-y-2/4 group-hover:border-white">
            <i
                class="p-1 text-3xl text-white border-2 border-white rounded-full cursor-pointer fa-solid fa-universal-access"></i>
        </div>
        <h5
...
<div id="menu-accessibility"
    ...
    <div class="flex flex-wrap gap-3 p-3 mx-auto mb-4 -mt-8 bg-white rounded-sm shadow-md w-[90%]">
        <button class="flex flex-col items-center w-[139.5px] py-2 bg-gray-100 rounded">
            ...
            <h5 class="text-[10px] font-semibold text-zinc-500">Fonte</h5>
        </button>
        ...
        <button id="aumentar" class="flex flex-col items-center w-[139.5px] py-2 bg-gray-100 rounded">
            ...
            <h5 class="text-[10px] font-semibold text-zinc-500 name">Tamanho Fonte</h5>
        </button>
        <button class="flex flex-col items-center w-[139.5px] py-2 bg-gray-100 rounded">
            <h5 class="flex items-center justify-center w-10 h-10 mb-2 text-xl bg-blue-900 rounded-full"><i
                    class="text-white fa-solid fa-text-width"></i></h5>
            <h5 class="text-[10px] font-semibold text-zinc-500">Espaçamento Fonte</h5>
        </button>
        <button class="flex flex-col items-center w-[139.5px] py-2 bg-gray-100 rounded">
            <h5 class="flex items-center justify-center w-10 h-10 mb-2 text-xl bg-blue-900 rounded-full"><i
                    class="text-white fa-solid fa-arrow-pointer"></i></h5>
            <h5 class="text-[10px] font-semibold text-zinc-500">Alterar Cursor</h5>
        </button>
        <button class="flex flex-col items-center w-[139.5px] py-2 bg-gray-100 rounded">
            <h5 class="flex items-center justify-center w-10 h-10 mb-2 text-xl bg-blue-900 rounded-full"><i
