<div
    class="flex sm:flex-col items-center justify-between mb-6 -mt-28 xl:-mt-[117px] xl:mb-4 lg:px-8 lg:-mt-[115px] sm:-mt-[110px] sm:px-4">
    ...
    <a href="{{ $linkButton }}" target="_blank"
        class="px-4 py-2 mb-10 text-sm font-semibold text-white bg-yellow-400 rounded-md shadow-md outline-none sm:mb-0 sm:self-start text sm:mt-3">{{ $nameButton }}
    </a>
</div>
