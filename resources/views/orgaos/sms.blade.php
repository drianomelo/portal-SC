<x-layout.orgaos bg="bg-sms">
    ...
    <section class="max-w-[1200px] mx-auto relative z-50 my-10 lg:px-5 sm:px-3">
        <!-- SECTION PROFILE -->
        <x-orgaos.profile name="Secretaria Municipal da Saúde" sigla="SMS"
            img="https://anexos.saocristovao.se.gov.br/storage/files/18/portal/icon/orgaos/sms.png" />
        ...
        <div class="max-w-[1200px] flex gap-12 xl:mb-10 sm:flex-col sm:gap-4 sm:mb-0">
            <div class="flex flex-col w-full gap-4 mx-auto">
                ...
                <div>
                    <div
                        class="flex justify-end text-center items-center mr-2.5 flex-col float-left sm:float-none sm:h-52 sm:mr-0 sm:mb-2 min-w-[280px] h-48 rounded-lg bg-cover bg-[url(https://anexos.saocristovao.se.gov.br/storage/files/18/portal/profile/fernanda.jpeg)]">
                ...
                <div class="overflow-auto table-responsive sm:block sm:w-full sm:overflow-x-auto">
                    <table class="w-full sm:text-xs">
                        ...
                        <tbody>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S JAIRO
                                    TEIXEIRA
                                    DE JESUS</td>
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">AV. FÉLIX PEREIRA
                                    S/N
                                    - CENTRO</td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">-</td>
                            </tr>
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S SINVAL JOSE
                                    DE
                                    OLIVEIRA</td>
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA J, S/N
                                    LOTEAMENTO
                                    LAURO ROCHA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">-</td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S MASSOUD
                                    JALALI
                                </td>
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA PROF. HORÁCIO
                                    DE
                                    SOUZA LIMA, S/N
                                    - ROSA ELZE
                                </td>
                            ...
                            <tr class="dark:text-white">
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA ALAN SILVA,
                                    367 -
                                    ROSA ELZE
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">-</td>
                            ...
                            <tr class="dark:text-white">
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">EDUARDO GOMES
                                </td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S LUIZ ALVES
                                </td>
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA B, 188,
                                    CONJUNTO
                                    LUIZ ALVES -
                                    ROSA ELZE
                                </td>
                            ...
                            <tr class="dark:text-white">
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">JÚLIA GRAZIELA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA SÃO LOURENÇO,
                                    292
                                    - TIJUQUINHA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">-</td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S MARIA LUIZA
                                    DOS
                                    SANTOS
                                    NASCIMENTO (CABRITA)</td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">POVOADO CABRITA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">LETÍCIA</td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">AV. PRINCIPAL,
                                    S/N -
                                    POVOADO CABRITA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">-</td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S JOSÉ
                                    MACÁRIO DE
                                    SANTANA
                                    (VÁRZEA)</td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S LAUDELINA
                                    LIMA
                                    DE ANDRADE
                                    (CAIPE VELHO)</td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">POVOADO CAIPE
                                    VELHO
                                </td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U S MARIA DE
                                    LOURDES
                                    ALVES (POV
                                    FEIJÃO)
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">POVOADO FEIJÃO
                                </td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U S F MANOEL
                                    JUVINO
                                    SANTOS (CARDOSO)
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">POVOADO CARDOSO
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">THIAGO</td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">AV. PRINCIPAL,
                                    S/N -
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S PARQUE
                                    SANTA
                                    RITA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">PARQUE SANTA
                                    RITA
                                </td>
                            ...
                            <tr class="dark:text-white">
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RITA CASSETE
                                </td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S TÂNIA
                                    SANTOS
                                    CHAGAS (COLÔNIA
                                    MIRANDA)
                                </td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S IRÔNIA
                                    MARIA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">ROMUALDO PRADO
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">SIMONE</td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">AV. PAULO
                                    BARRETO DE
                                    MENEZES -
                                    ROMUALDO PRADO
                                </td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">CAPS VALTER
                                    CORREIA
                                </td>
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">AV. HORÁCIO DE
                                    SOUZA
                                    LIMA – ALTO DA
                                    DIVINEIA
                                </td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">CAPS JOÃO BEBE
                                    ÁGUA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">ROSA MARIA</td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">CENTRO
                                    ESPECIALIZADO
                                    EM
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">AV. LOURIVAL
                                    BATISTA
                                    – LOURIVAL
                                    BATISTA
                                </td>
                            ...
                            <tr class="dark:text-white">
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA PROF.
                                    HORÁCIO DE
                                    SOUZA LIMA,
                                    156 - ROSA ELZE
                                </td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">CONSELHO
                                    MUNICIPAL
                                    DE SAÚDE
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">CENTRO</td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">SECRETARIA
                                    MUNICIPAL
                                    DE SAÚDE
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">CENTRO</td>
                            ...
                            <tr class="dark:text-white">
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA 62, 624 -
                                    CONJ.
                                    EDUARDO GOMES
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">-</td>
                            ...
                            <tr class="dark:text-white">
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">U B S BRUNO
                                    KAIQUE
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">MADRE PAULINA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">SARA TRAVASSOS
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA A, 167 -
                                    MADRE
                                    PAULINA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">-</td>
                            ...
                            <tr class="dark:text-white">
                                ...
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">MARCELO DEDA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">ADRIELLE</td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">RUA D, S/N -
                                    BAIRRO
                                    MARCELO DEDA
                                </td>
                                <td class="p-2 pl-4 text-[11px] sm:text-[10px] font-light border text">-</td>
            ...
            <div class="max-w-[350px] flex flex-col gap-4 sm:max-w-full">
                ...
                <div class="flex flex-col gap-4">
                    <a href="https://anexos.saocristovao.se.gov.br/arquivos/portal/orgaos/sms/EducacaoPermanente.pdf"
                        class="w-full p-4 text-3xl font-bold text-center text-white bg-blue-900 rounded-md shadow-md">
                        Educação Permanente
                    </a>
                    <a href="{{ route('banners.seminario') }}"
                        class="w-full p-4 text-3xl font-bold text-center text-white bg-blue-900 rounded-md shadow-md">
                        II Seminário de Boas Práticas
                    </a>
                    <a href="{{ route('banners.planomunicipalsaude') }}"
                        class="w-full p-4 text-3xl font-bold text-center text-white bg-blue-900 rounded-md shadow-md">
