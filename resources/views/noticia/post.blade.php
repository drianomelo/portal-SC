        ...
        <div class="flex flex-col w-full">
            ...
            <div class="px-3 mt-5 dark:text-white text">
                ...
                <div class="relative mt-10 mb-5">
                    <div
                        class="absolute z-50 w-fit right-0 bottom-3 px-3 text-center rounded-s h-[5%] flex items-center bg-blue-950 bg-opacity-70">
                        <span class="flex items-center gap-1.5 text-[11px] font-bold text-yellow-400">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-sm font-extrabold">Dani Santos</span>
                    </div>
                </div>
            </div>
        </div>
