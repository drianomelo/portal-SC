<x-layout>
    ...
    <div class="min-w-[1200px] mx-auto mb-10 xl:pb-0 lg:px-5 sm:px-3 lg:min-w-full">
        <x-title img="" h2="Fichas de cadastro" p="Fichas de cadastro"></x-title>
        <ul class="flex flex-col gap-2 pl-5 mt-4 dark:text-white text">
            <li class="text-justify list-disc">
                <a class="text-blue-400" target="blank"
                    href="https://docs.google.com/forms/d/10nINquv9HHa-ds9w60wVXPZQ3F9yKpz6VPS6ssx09o4/edit">
                    Terreiros de matriz africana
                </a>
            </li>
            <li class="text-justify list-disc">
                <a class="text-blue-400" target="blank"
                    href="https://docs.google.com/forms/d/1F8yYLDObHp3WVLNhbOZjw_bJ6PYnVUtvQuEzbS9J8mY/edit">
                    Indígenas
                </a>
            </li>
            <li class="text-justify list-disc">
                <a class="text-blue-400" target="blank"
                    href="https://docs.google.com/forms/d/1qQ1OLVtqZxGC-PxMsUmrm7BV7yiPBS__puTOASf6BM0/edit">
                    Rezadeiras e benzedeiras
                </a>
            </li>
            <li class="text-justify list-disc">
                <a class="text-blue-400" target="blank"
                    href="https://docs.google.com/forms/d/13q_noPH026Shp5jstMlqXWDfLYwITL99cfm4FNFwf_U/edit">
                    Parteiras
                </a>
            </li>
        </ul>
