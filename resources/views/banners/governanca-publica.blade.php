    ...
    <div class="max-w-[1200px] mx-auto mb-10 xl:pb-0 lg:px-5 sm:pt-5">
        ...
        <div class="mb-6">
            <p
                ...
                avaliar,
                direcionar e monitorar a gestão, com vistas à condução e geração de resultados nas políticas públicas e
                à
                prestação de serviços de interesse da sociedade. Envolve o compliance público com o seu alinhamento e
                adesão
                a valores, princípios e normas para sustentar e priorizar o interesse público em relação ao interesse
            ...
            <p class="mt-2 text-justify sm:text-xs sm:first-letter:text-6xl dark:text-white text">
                ...
                modifiquem
                aspectos do conjunto da sociedade ou de grupos específicos reconhecidos como destinatários legítimos de
                bens
                e serviços públicos.
            </p>
            <p class="mt-2 text-justify sm:text-xs sm:first-letter:text-6xl dark:text-white text">
        ...
        <x-title img="" h2="Anexos"
            p="Anexos da Governança Pública"></x-title>
