<x-layout>
        ...
        <div class="min-w-[1200px] mx-auto lg:px-5 lg:min-w-full sm:px-3">
            <div class="relative z-50 flex items-center justify-between mb-6 -mt-5">
                <div class="">
                    ...
                    ]" :last="['nome' => 'Concurso Guarda Civil Municipal e outras áreas', 'url' => '']" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-[1200px] mx-auto mb-10 xl:pb-0 lg:px-5 sm:px-3">
        <x-title img="" h2="Editais" p="Editais do Concurso Guarda Civil Municipal e outras áreas"></x-title>
        <table id="table_concursos" class="w-full mt-3 sm:text-xs">
            <thead>
                <tr class="text-blue-900 bg-zinc-100 dark:bg-zinc-900">
                    <th class="p-2 pl-3 border border-b-0 text text-start">Ano</th>
                    <th class="p-2 pl-3 border border-b-0 text text-start">Nome</th>
                    <th class="p-2 pl-3 border border-b-0 text text-start">Exportar</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($editais as $edital)
                    <tr class="dark:text-white">
                        <td class="p-2 pl-3 text-[11px] font-light border text">{{ $edital[0] }}</td>
                        <td class="p-2 pl-3 text-[11px] font-light border text">{{ $edital[1] }}</td>
                        <td class="p-2 pl-3 text-[11px] font-light border text">
