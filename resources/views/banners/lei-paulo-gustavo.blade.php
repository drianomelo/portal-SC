    ...
    <div class="max-w-[1200px] mx-auto mb-10 xl:pb-0 lg:px-5 sm:pt-5">
        ...
        <div class="mb-6">
            <p
                ...
                Conforme Decreto de Lei nº 11.525/23, Art. 17, o município pode utilizar até 05 (cinco) por cento dos
        ...
        <div class="mb-6">
            <p
                class="mt-2 text-justify sm:text-xs sm:first-letter:text-6xl dark:text-white first-letter:text-7xl first-letter:font-bold first-letter:mr-3 first-letter:text-yellow-400 first-letter:float-left text">
                Em 30 de Novembro de 2023 a Fundação Municipal de Cultura e Turismo ‘João Bebe Água’ (FUMCTUR) divulgou
        ...
        <ul class="flex flex-col gap-2 pl-5 mt-4 mb-6 dark:text-white text">
            ...
            <li class="text-justify list-disc">
                <a class="text-blue-400" href="https://drive.google.com/file/d/1G_tB8CqLdWn4kQV6iHcrS9v9D6x2KwKH/view"
            ...
            <li class="text-justify list-disc">
                <a class="text-blue-400" href="https://drive.google.com/file/d/1RdfA_eogb5uDF6Wuq8ZDxxf7KnaOszZp/view"
        ...
        <ul class="flex flex-col gap-2 pl-5 mt-4 mb-6 dark:text-white text">
            ...
            <li class="text-justify list-disc">
                <a class="text-blue-400"
                    href="https://www.in.gov.br/web/dou/-/decreto-n-11.525-de-11-de-maio-de-2023-482720690"> Decreto nº
