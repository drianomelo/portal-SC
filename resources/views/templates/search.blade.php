    ...
    <div class="min-w-[1200px] relative flex items-center justify-center">
        ...
        <form action="#">
            ...
            <div class="relative flex items-center justify-between p-1 bg-white rounded">
                ...
                <input class="text-gray-400 border-0 outline-none placeholder:text-gray-400" type="text" name="pesquisa" id="pesquisa" required placeholder="Teste">
                <button class="p-2 text-[10px] font-bold text-white uppercase bg-blue-900 rounded" type="submit">Pesquisar</button>
            </div>
        </form>
        <button type="button" class="absolute right-0 flex items-center justify-center w-6 h-6 bg-white border-none rounded-full search-close">
